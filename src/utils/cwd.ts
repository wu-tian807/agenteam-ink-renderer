// @ts-nocheck claude-code utility, adapted for agenteam_os
import { AsyncLocalStorage } from 'async_hooks'

// Stubs: agenteam_os doesn't have a bootstrap state; cwd is always process.cwd()
function getCwdState(): string { return process.cwd(); }
function getOriginalCwd(): string { return process.cwd(); }
