...
export default class Ink {
  ...
  constructor(private readonly options: Options) {
    ...
    // @ts-ignore Dead code check for React DevTools
  ...
  dispatchClick(col: number, row: number): boolean {
    ...
    // Force full redraw so nodeCache rects reflect current scroll positions.
    // DECSTBM fast-path scrolling skips cache updates for stable children;
    // without this, blit reuses stale prevScreen and hitTest misses targets.
    this.prevFrameContaminated = true;
    this.onRender();
